...
importar_arquivo = st.file_uploader(label='Importar', type=['csv'])

# Verifica se foi importado algo
if importar_arquivo:

    # Leitura dos dados
    df = pd.read_csv(importar_arquivo, dtype={'Codigo': str})
    
    # Remoção das duplicatas
    df_limpo = df.drop_duplicates(subset='Codigo')
